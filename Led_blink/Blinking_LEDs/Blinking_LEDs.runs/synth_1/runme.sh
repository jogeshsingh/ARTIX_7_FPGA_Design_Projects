...
HD_PWD='E:/VIVADO_2022/ARTIX_A7_FPGA/Led_blink/Blinking_LEDs/Blinking_LEDs.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Led_Blink_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Led_Blink_test.tcl
