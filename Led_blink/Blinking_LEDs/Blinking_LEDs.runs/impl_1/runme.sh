...
HD_PWD='E:/VIVADO_2022/ARTIX_A7_FPGA/Led_blink/Blinking_LEDs/Blinking_LEDs.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Led_Blink_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Led_Blink_test.tcl -notrace
