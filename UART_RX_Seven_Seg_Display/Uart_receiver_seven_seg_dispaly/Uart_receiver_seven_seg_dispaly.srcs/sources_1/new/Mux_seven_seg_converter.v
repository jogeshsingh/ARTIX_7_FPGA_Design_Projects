...
// Engineer: 
// 
// Create Date: 10/03/2023 12:10:28 PM
// Design Name: 
// Module Name: Mux_seven_seg_converter
// Project Name: 
...
// Multiplexer used to select one of the two seven seg display //
...
`define WIDTH_SEG 4
`define WIDTH_EN 4
module Mux_seven_seg_converter(
input i_clk ,  
//input i_rst_n ,
