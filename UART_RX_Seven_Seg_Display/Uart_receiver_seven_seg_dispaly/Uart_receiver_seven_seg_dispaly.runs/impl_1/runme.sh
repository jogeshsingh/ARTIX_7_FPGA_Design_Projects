...
HD_PWD='E:/VIVADO_2022/SERIAL_PROTOCOLS/UART_RX_Seven_Seg_Display/Uart_receiver_seven_seg_dispaly/Uart_receiver_seven_seg_dispaly.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_design.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Top_design.tcl -notrace
