...
HD_PWD='E:/VIVADO_2022/ARTIX_A7_FPGA/Debugging/Debugging_Xilinx_IPs/Debuggin_various_IPs/Debuggin_various_IPs.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Spi_interface_debug_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Spi_interface_debug_wrapper.tcl -notrace
