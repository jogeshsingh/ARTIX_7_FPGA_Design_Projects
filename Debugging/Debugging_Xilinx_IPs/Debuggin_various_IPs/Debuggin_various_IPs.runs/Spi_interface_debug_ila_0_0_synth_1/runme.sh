...
HD_PWD='E:/VIVADO_2022/ARTIX_A7_FPGA/Debugging/Debugging_Xilinx_IPs/Debuggin_various_IPs/Debuggin_various_IPs.runs/Spi_interface_debug_ila_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Spi_interface_debug_ila_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Spi_interface_debug_ila_0_0.tcl
