...
HD_PWD='E:/VIVADO_2022/ARTIX_A7_FPGA/Debugging/Debugging_Xilinx_IPs/Counter_debug/cnt_debug/cnt_debug.runs/design_1_c_counter_binary_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_c_counter_binary_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_c_counter_binary_0_0.tcl
