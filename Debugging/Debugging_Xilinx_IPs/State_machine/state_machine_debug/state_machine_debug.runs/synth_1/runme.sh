...
HD_PWD='E:/VIVADO_2022/ARTIX_A7_FPGA/Debugging/Debugging_Xilinx_IPs/State_machine/state_machine_debug/state_machine_debug.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log one_bit_overlapping_moore_machine.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source one_bit_overlapping_moore_machine.tcl
