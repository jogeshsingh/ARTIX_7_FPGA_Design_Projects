...
HD_PWD='E:/VIVADO_2022/ARTIX_A7_FPGA/ASYNCHRONOUS_FIFO/Asynch_FIFO/Asynch_FIFO.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_async_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Top_async_fifo.tcl
