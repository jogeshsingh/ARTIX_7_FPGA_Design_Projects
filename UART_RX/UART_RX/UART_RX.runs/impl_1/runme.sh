...
HD_PWD='E:/VIVADO_2022/ARTIX_A7_FPGA/UART_RX/UART_RX/UART_RX.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_receiver.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uart_receiver.tcl -notrace
