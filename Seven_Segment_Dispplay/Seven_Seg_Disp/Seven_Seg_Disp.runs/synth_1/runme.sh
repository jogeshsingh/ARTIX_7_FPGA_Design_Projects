...
HD_PWD='E:/VIVADO_2022/ARTIX_A7_FPGA/Seven_Segment_Dispplay/Seven_Seg_Disp/Seven_Seg_Disp.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Seven_seg_mod.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Seven_seg_mod.tcl
