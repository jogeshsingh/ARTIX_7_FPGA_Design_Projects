...
HD_PWD='E:/VIVADO_2022/ARTIX_A7_FPGA/Seven_Segment_Dispplay/Seven_Seg_Disp/Seven_Seg_Disp.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Seven_seg_mod.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Seven_seg_mod.tcl -notrace
