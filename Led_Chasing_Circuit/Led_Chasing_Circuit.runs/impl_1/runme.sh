...
HD_PWD='E:/VIVADO_2022/ARTIX_A7_FPGA/Led_Chasing_Circuit/Led_Chasing_Circuit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Led_chase.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Led_chase.tcl -notrace
