...
HD_PWD='E:/VIVADO_2022/ARTIX_A7_FPGA/Led_Chasing_Circuit/Led_Chasing_Circuit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Led_chase.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Led_chase.tcl
